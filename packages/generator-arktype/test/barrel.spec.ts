...
describe('@drzl/generator-arktype barrel', () => {
  const cases: { fileSuffix?: string; file: string; specifier: string; importable?: boolean }[] = [
    { fileSuffix: undefined, file: 'users.arktype.ts', specifier: './users.arktype' },
    ...
    { fileSuffix: '.arktype.tsx', file: 'users.arktype.tsx', specifier: './users.arktype' },
    ...
    { fileSuffix: '.arktype.mts', file: 'users.arktype.mts', specifier: './users.arktype.mjs' },
    { fileSuffix: '.arktype.cts', file: 'users.arktype.cts', specifier: './users.arktype.cjs' },
