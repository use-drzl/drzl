...
npm install --no-audit --no-fund --loglevel=error \
  "$TARS"/*.tgz drizzle-orm zod valibot arktype effect @orpc/server @trpc/server hono @hono/standard-validator express @types/express fastify @nestjs/common @modelcontextprotocol/server @valibot/to-json-schema ai @tanstack/react-start h3@^1.15.11 @effect/platform @ts-rest/core@^3.53.0-rc.1 elysia @sinclair/typebox typescript tsx prettier >/dev/null
