...
Valid kinds are: orpc, trpc, hono, express, fastify, nestjs, graphql, ai, effect-http, elysia, h3, mcp, next, tanstack-start, ts-rest, seed, fast-check, service, zod, valibot, arktype, typebox, effect, json-schema.
```
