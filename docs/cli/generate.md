...
Valid kinds are: orpc, trpc, hono, express, fastify, nestjs, graphql, ai, effect-http, h3, mcp, next, tanstack-start, ts-rest, service, zod, valibot, arktype, typebox, effect, json-schema.
```
